...
export class Migration20230807113329 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table `pokemon_type` (`id` int unsigned not null auto_increment primary key, `name` varchar(255) not null) default character set utf8mb4 engine = InnoDB;');
