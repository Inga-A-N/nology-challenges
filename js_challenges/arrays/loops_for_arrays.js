// Challenge: Sum of n
// MVP: Create a function with a for loop that will add all the numbers up to n

// You should create a variable to set the upper limit of your loop Your loop should increment by 1 on each iteration Your loop should print the final result
...
// MVP: Create a function with a for loop that will add numbers to your shopping list

// Store the following array in a variable Your loop should iterate through every value in the array Your loop should print a shopping list with the number and the name of the item
...
// Bonus Keep vowels in the new strings if they are succeeded by the letters l, m, or r
